// Adapted from Yafc-CE (GPL-3.0): https://github.com/Yafc-CE/yafc-ce
// Original: Yafc.Parser/FactorioPropertyTree.cs
// Licensed under GPL-3.0
// Unchanged from upstream except for namespace (Yafc.Parser kept as-is to ease diffs).
